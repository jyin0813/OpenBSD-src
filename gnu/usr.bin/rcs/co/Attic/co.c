 ...
 * fix comments s/$Id: co.c,v 1.6 1996/05/31 13:11:06 deraadt Exp millert $/Id/, and usage string.
 *
...
mainProg(coId, "co", "$Id: co.c,v 1.6 1996/05/31 13:11:06 deraadt Exp millert $")
{
